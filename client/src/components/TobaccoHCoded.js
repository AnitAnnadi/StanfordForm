    ...
    >
      <Wrapper>
        <form className="form" onSubmit={handleSubmit}>
          ...
          <div className="form">
            <h4>I know that the “vapor” that comes out of a vaping device is:</h4>
            ...
            <h4 className="form-title">How Much Waste/Garbage Do You Believe Tobacco/Vaping Products Produce?</h4>
