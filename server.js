...
// ✅ CORS - Important for preflight OPTIONS & cross-origin
app.use(
  cors({
...
// ✅ Static files - moved to AFTER API routes
...
import http from "http"; // ⬅️ Add this line
...
const start = async () => {
  try {
    ...
    server.timeout = 10 * 60 * 1000; // ⏱️ 10 minutes timeout
