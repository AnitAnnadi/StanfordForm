...
const StudentResponseSchema = new mongoose.Schema(
  {
    ...
    formType:{
      type: String,
      enum: ['You and Me, Together Vape-Free(elem)','You and Me Vape Free (middle school and above)', 'Smart Talk: Cannabis Prevention & Education Awareness','Safety First', 'Healthy Futures: Tobacco/Nicotine/Vaping','Healthy Futures: Cannabis'],
